...
Examples:
    python unwrap.py results/acme-corp/repos/
    python unwrap.py results/acme-corp/org.sealed.json
...
# Allow importing sealing from the skill when run from batch output dir
SKILL_SCRIPTS = Path(__file__).resolve().parent.parent.parent / "repo-quality-score" / "scripts"
