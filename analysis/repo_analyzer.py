...
Usage:
  # --- GitLab ---
  repo-analyzer --provider gitlab --project "group/repo" --token glpat-XXXX
  repo-analyzer --provider gitlab --group "my-group" --token glpat-XXXX
  repo-analyzer --project "team/app" --token XXXX \\
      --gitlab-url https://gitlab.mycompany.com

  # --- GitHub ---
  repo-analyzer --provider github --project "owner/repo" --token ghp_XXXX
  repo-analyzer --provider github --org "my-org" --token ghp_XXXX

  # --- Offline / Local repo (no internet required) ---
  repo-analyzer --provider local --path /home/user/my-repo
  repo-analyzer --path C:\\code\\repo1 --path C:\\code\\repo2
