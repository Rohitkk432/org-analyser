...
from eval.production_quality_check import _check_repo as _check_repo_production
from eval.security_check import _check_repo as _check_repo_security
from eval.vibecode_check import _check_repo as _check_repo_vibecode
